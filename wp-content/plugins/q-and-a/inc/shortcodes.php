...
function qahome_shortcode( $atts ) {
	...
	if ( $id ) { // Show a single entry //
		...
		$qaplus_shortcode_output .=  '<div class="qa-category">
			<h2 class="faq-catname" id="'.$category->name.'">' . $category->name . '</h2>
			';	
		...
		if ( $categories ) {
           ...
           $qaplus_shortcode_output .=  '<div id="Index" class="qa-index"><ul>';
           foreach($categories1 as $cat){
             $qaplus_shortcode_output0 .=  '<li><a href="#'.$cat->name.'">'.$cat->name.'</a> </li>';
           }
          
           $qaplus_shortcode_output .=  $qaplus_shortcode_output0.'</ul></div>';
			...
			foreach ( $categories as $category ) {
				...
				$qaplus_shortcode_output .=  '<div class="qa-category">
				<h2 class="faq-catname" id="'.$category->name.'" >' . $catheader . '</h2>
				';
				...
				$qaplus_shortcode_output .= '<br><a href="#" class="top_link">Back To Top</a><br></div><!-- .qa-category-->';
...
function qa_search() { 
    ...
    $searchform = '<form role="search" method="get" id="qaplus_searchform" action="' . home_url() . '">
		<input type="text" value="Search FAQs"  name="s" id="qasearch" class="qaplus_search" />
