...
<div id="infoBox" >
      ...
      <div class="upcomingEvents">
        <div id="upcomingEventsContainer">
          ...
          <div class="upcomingEventRow textMain">
           ...
           <div class="floatright"> <div class="clear"><a href="<?php echo get_permalink($post->ID); ?>" class="upcomingEventTxt linkMain"> <?php echo (get_the_title()); ?></a></div>
  ...
  <div class="event_main_block">
    ...
    <div class="event_box">
            <h1>GIVE BACK</h1>
	    <div style="width:140px; float:left; color:#FFFFFF;margin: 5px; padding-top: 10px;">
		Donate to organizations that honor the fallen and make a difference in the lives of military families.
	    </div>
	    <div style="width:140px;float:left;">
	    <a href="/charities"><img src="<?php bloginfo('template_url'); ?>/images/31heroes.png" width="140"></a>
	    </div>
   </div>
...
<div class="event_box" style="color: white;">
            <h1>CONNECT TO CMC</h1>
		<div style="padding:5px; padding-top:10px; padding-left:7px;">
		<h6>Sign-up to receive <b>exclusive offers</b> ONLY available to members.</h6>
		<br/>
