...
var popUpCal = {
	...
	autoPopUp: 'click', // 'focus' for popup on focus, 'button' for trigger button, or 'both' for either
	...
	connectCalendar: function(target) {
		...
		if (this.autoPopUp == 'focus' || this.autoPopUp == 'both' || this.autoPopUp == 'click' ) { // pop-up calendar when in the marked fields
