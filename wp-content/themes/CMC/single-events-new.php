            ...
            <div class="inner_mid_inner">
                <div class="clear">
                    ...
                    <div class="floatright">
                        ...
                        <a href="http://www.eventbrite.com/event/<?php echo $eb_id ?>" class="register_big_btn"  ></a>  
                        <?php }?> 
                    </div>
                    <div class="clear"></div>
                </div>
    ...
    <div id="signup_media_results" style="display:<?php echo $div_media; ?>;">
        ...
        <div class="inner_mid_inner">
             ...
             <div class="clear">
                <h1 class="strenth_star floatleft">MEDIA</h1>
                 <?php /* ?> <div class="floatright">  <a href="http://www.eventbrite.com/event/<?php echo $eb_id ?>" class="register_big_btn" ></a> 
                <?php */ ?>
      ...
      <div class="clear"></div>
            ...
            wp_reset_query(); 
             ...
             <?php }/* ?>
           <div class="button_block"> <a class="register_big_btn"  href="http://www.eventbrite.com/event/<?php echo $eb_id ?>"></a>
